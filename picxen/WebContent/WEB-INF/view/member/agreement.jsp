...
<!-- chkId -->
			...
			<!-- <input type="hidden" id="idChk" name="idChk" value=""> --> <!-- testCheck -->
		...
		<div class="form-group">
			<div class="col-xs-10">
				<!-- <input type="button" class="btn btn-logi" style="color:#ffffff;" value="완료" onclick="return send()"> -->
...
/*  				alert("idCnt"+idCnt); */
	...
	$(window).load(function(){
		$(window).resize(function(){
			...
			if(diSize >= 495){
				$('.loginBox').css({'width':'400px','margin-top':'120px'});
			}
			if(diSize < 495){
				$('.loginBox').css({'width':'300px','margin-top':'20px'});
			}
		}).resize();
	});
