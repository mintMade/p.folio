...
<!-- log_if -->	   <%-- <c:if test="${clikeBean.userid == userid && mcvBean.commentNo == clikeBean.commentNo}"> --%>
...
<!-- 탑 추천 -->						
						...
						<div style="float:right;" >	
							...
							<input type="text" name="userid" id ="topUsrid${cnt}" value="${mcvBean.userid}">
							<%-- <input type="text" name="userid1" id ="topUsrid1${cnt}" value="${userid}">	 --%>
							<input type="text" id="logUsrId${lcnt}"  value="${clikeBean.userid}">							
