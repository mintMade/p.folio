  	...
  	<div id="horiz-menu" style="float:left; ">
		    <c:if test="${param.cgName==null}">
				 <div class="" style="margin-right: 20px; float:left; ">
				    <a href="${pageContext.request.contextPath}/photo/photo/popular.do" style="color: #ff1493;"
		    ...
		    <c:if test="${param.cgName!=null }">
				<div class="" style="margin-right: 20px; float:left;">		    
		    		<a href="${pageContext.request.contextPath}/photo/photo/popular.do?cgName=${param.cgName}" style="color: #ff1493;"
		    			id="pt_list_Btn" >인기 사진</a>
				</div>		    		
		    </c:if>
