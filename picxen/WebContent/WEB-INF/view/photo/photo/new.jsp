...
<div style="">
	...
	<c:forEach var="i" begin="1" end="${pb.pageSize}">
		<c:if test="${num >= 1}">
    		...
    		<a href ="${pageContext.request.contextPath}/photo/photo/photoCountUpdate.do?ptNo=${ptBean.photoNo}&userid=${userid}&sort=new&ip=<%=ip %>"  >
...
$( document ).ready(function() {
	...
	function getListByPage(curPage){
		...
		frmPage.action
		="<c:url value='/photo/photo/new.do'/>";
		frmPage.submit();
	}
</script>
