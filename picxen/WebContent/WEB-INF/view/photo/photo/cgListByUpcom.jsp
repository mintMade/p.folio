	...
	<div class="" style="float:left;  border-right: 1px solid #E5E5E5; margin-right: 10px;">
  	...
  	<div id="horiz-menu" style="float:left; ">
		    ...
		    <c:if test="${param.cgName!=null }">
		  	...
		  	<c:if test="${param.cgName==null }">
		  		<div class="" style="margin-right: 20px; float:left;">		  	
			  		<a href="${pageContext.request.contextPath}/photo/photo/new.do" 
		  	...
		  	<c:if test="${param.cgName!=null }">
		  	  	<div class="" style="margin-right: 20px; float:left;">
		    		<a href="${pageContext.request.contextPath}/photo/photo/new.do?cgName=${param.cgName}" 
		    			id="pt_list_Btn">새로 올라온 사진</a>
		    	</div> 
		 	</c:if> 
		  	...
		  	<c:if test="${param.cgName==null }">
		  		<div class="" style="margin-right: 20px; float:left;">
			    	<a href="${pageContext.request.contextPath }/photo/photo/upcoming.do" style="color: #ff1493;"
		    ...
		    <c:if test="${param.cgName!=null }">
		      	<div class="" style="margin-right: 20px; float:left;">
		    		<a href="${pageContext.request.contextPath }/photo/photo/upcoming.do?cgName=${param.cgName}" style="color: #ff1493;"
		    			id="pt_list_Btn">뜨고 있는 사진</a>
				</div>		    		    			
		    </c:if>
	 </div>
