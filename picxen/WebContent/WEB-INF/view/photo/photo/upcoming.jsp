...
<div style="background-color:#FFFFFF;">
	<%@include file="cgListByUpcom.jsp" %>
</div>
...
<div style="">
	...
	<c:forEach var="i" begin="1" end="${pb.pageSize}">
		<c:if test="${num >= 1}">
    		...
    		<a id="wave" href ="${pageContext.request.contextPath}/photo/photo/photoCountUpdate.do?ptNo=${ptBean.photoNo}&userid=${userid}&sort=upc&ip=<%=ip %>"  >
    			...
    			<a href="${pageContext.request.contextPath }/photo/photo/photoCountUpdate.do?ptNo=${ptBean.photoNo}&userid=${userid}&sort=upc&ip=<%=ip %>" 
...
$( document ).ready(function() {
  ...
  window.onload=function(){
	...
	function getListByPage(curPage){
		...
		frmPage.action
		="<c:url value='/photo/photo/upcoming.do'/>";
		frmPage.submit();
	}
</script>
